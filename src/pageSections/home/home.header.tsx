...
const HomeHeader = () => {
  return (
    <section className="text-gray-600 body-font container" id="home">
      <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
        <div className="lg:flex-grow md:w-1/2 pr-8 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
